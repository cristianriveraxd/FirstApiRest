...
FILE_PATH = os.path.expanduser("~/Documentos/AppiRest/AppiRest/AppiRest/DatosPrivadosCorreo.csv")
FILE_PATH1 = os.path.expanduser("~/Documentos/AppiRest/AppiRest/AppiRest/DatosPublicos.csv")
...
def limpiar_monto(monto):
    """Limpia y convierte el valor del monto a float."""
    if not monto:  
        return 0
...
def importar_envios():
    """Importa registros desde un CSV de envíos."""
